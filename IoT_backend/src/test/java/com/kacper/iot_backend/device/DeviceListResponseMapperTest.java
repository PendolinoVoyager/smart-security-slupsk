...
class DeviceListResponseMapperTest
{
    ...
    void shouldMapDeviceToResponse() {
        Device device = new Device(1, "Grove street 1", "Device1", "uuid1", null, null);
    ...
    void shouldMapDevicesListToResponseList() {
        List<Device> devices = List.of(
                new Device(1, "Grove street 1", "Device1", "uuid1", null, null),
                new Device(2, "Grove street 2", "Device2", "uuid2", null, null)
        );
